...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		debugger // 读取配置的 Entrys，为每个 Entry 实例化一个对应的 EntryPlugin，为后面该 Entry 的递归解析工作做准备。
		...
		debugger // 调用完所有内置的和配置的插件的 apply 方法。
		...
		debugger // 根据配置初始化完 resolver，resolver 负责在文件系统中寻找指定路径的文件。
